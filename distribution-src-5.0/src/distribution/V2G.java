...
public class V2G extends DefaultReporter {
	...
	public Syntax getSyntax() {
		return Syntax.reporterSyntax(new int[] {Syntax.ListType(), Syntax.NumberType(), Syntax.NumberType(), Syntax.NumberType(), Syntax.NumberType(), Syntax.NumberType()}, Syntax.ListType());
	}
	...
	public Object report(Argument args[], Context context) throws ExtensionException {
    	...
    	if (coalizao.size() < 2 || coalizao.size() > gamma) return new Double(0);
